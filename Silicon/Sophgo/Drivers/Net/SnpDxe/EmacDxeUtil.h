...
typedef struct {
  ...
  UINT32 MtlChan;
  UINT32 MtlChanOffset;
  UINT32 MtlEtsCtrl;
  UINT32 MtlEtsCtrlOffset;
  UINT32 MtlTxqWeight;
  UINT32 MtlTxqWeightOffset;
  UINT32 MtlSendSlpCred;
  UINT32 MtlSendSlpCredOffset;
  UINT32 MtlHighCred;
  UINT32 MtlHighCredOffset;
  UINT32 MtlLowCred;
  UINT32 MtlLowCredOffset;
} Dwmac4Addrs;
