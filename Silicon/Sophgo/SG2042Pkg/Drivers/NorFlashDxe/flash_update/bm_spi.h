...
#define SPI_CMD_4BYTE_SE		0xDC
#define SPI_CMD_4BYTE_PP		0x12
#define SPI_CMD_4BYTE_READ		0x13
#define SPI_CMD_ENABLE_4BYTE_MODE	0xB7
#define SPI_CMD_DISABLE_4BYTE_MODE	0xE9
