  ...
  )
{
  ...
  EfiConvertPointer (0x0, (VOID**)&mI2cMasterProtocol->ReadByte);
  EfiConvertPointer (0x0, (VOID**)&mI2cMasterProtocol->WriteByte);
  EfiConvertPointer (0x0, (VOID**)&mI2cMasterProtocol->Read);
  EfiConvertPointer (0x0, (VOID**)&mI2cMasterProtocol->Write);

  for (Count = 0; Count < I2cNum; Count++) {
    EfiConvertPointer (0x0, (VOID **)&mI2cInfo[Count].Base);
  }
}
