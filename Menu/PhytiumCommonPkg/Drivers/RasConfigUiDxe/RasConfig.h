/** @file
The header file of HII Config Access protocol implementation of ras configuration module.

Copyright (c) 2024, Phytium Technology Co., Ltd. All rights reserved.

SPDX-License-Identifier: BSD-2-Clause-Patent
**/
#ifndef  RAS_CONFIG_H_
#define  RAS_CONFIG_H_
...
extern EFI_GUID mRasConfigGuid;

//
// These are the VFR compiler generated data representing our VFR data.
//

#define RAS_CONFIG_CALLBACK_DATA_SIGNATURE  SIGNATURE_32 ('R', 'A', 'S', 'C')
#define RAS_CONFIG_CALLBACK_DATA_FROM_THIS(a)  CR (a, RAS_CONFIG_CALLBACK_DATA, ConfigAccess, RAS_CONFIG_CALLBACK_DATA_SIGNATURE)
...
} RAS_CONFIG_CALLBACK_DATA;

extern RAS_CONFIG_CALLBACK_DATA  gRasConfigPrivate;
