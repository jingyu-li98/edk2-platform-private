...
//
EFI_COMPONENT_NAME_PROTOCOL     gPhyComponentName = {
  PhyComponentNameGetDriverName,
  PhyComponentNameGetControllerName,
  "eng"
};

static EFI_UNICODE_STRING_TABLE mPhyDriverNameTable[] = {
  { "eng", L"Phytium X100 GOP v2.4 20231011" },
  { NULL , NULL }
};

static EFI_UNICODE_STRING_TABLE mPhyControllerNameTable[] = {
  { "eng", L"Phytium X100 display v2.4 20231011" },
  { NULL , NULL }
};
