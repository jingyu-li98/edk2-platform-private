  ...
  )
{
  ...
  BlockHeader = Block;
  ZeroMem (&BlockHeader->BlockStatus, sizeof (EFI_ACPI_6_4_ERROR_BLOCK_STATUS));
  ...
  )
{
  ...
  EntriesBegin = ErrorBlock + sizeof (EFI_ACPI_6_4_GENERIC_ERROR_STATUS_STRUCTURE);
  ...
  )
{
  ...
  if (sizeof (EFI_ACPI_6_4_GENERIC_ERROR_STATUS_STRUCTURE) + ExpectedNewDataLength >
      MaxBlockLength) {
  ...
  //
  Entry = (EFI_ACPI_6_4_GENERIC_ERROR_DATA_ENTRY_STRUCTURE*)(ErrorBlock +
           sizeof (EFI_ACPI_6_4_GENERIC_ERROR_STATUS_STRUCTURE) +
           BlockHeader->DataLength);
  SetMem (Entry, sizeof (EFI_ACPI_6_4_GENERIC_ERROR_DATA_ENTRY_STRUCTURE), 0);
...
{
  if (PreAllocatedHestSize < sizeof (EFI_ACPI_6_4_HARDWARE_ERROR_SOURCE_TABLE_HEADER)) {
  ...
  *Context->HestHeader = (EFI_ACPI_6_4_HARDWARE_ERROR_SOURCE_TABLE_HEADER) {
   ARM_ACPI_HEADER (
...
VOID
GhesV2Initial (
  IN OUT EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE *GhesV2,
  ...
  )
{
  ...
  *GhesV2 = (EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE) {
    .Type = EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_VERSION_2,
    .SourceId = 0,
    ...
    .NotificationStructure = {
      .Type = EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_GSIV,
      .Length = sizeof (EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE),
...
GhesV2AddNotification (
  IN EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE  *This,
  IN UINT8                                                           Type,
  IN UINT32                                                          Vector
  )
{
  This->NotificationStructure = (EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_STRUCTURE) {
    .Type = Type,
    .Length = sizeof (EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE),
...
GhesV2LinkErrorBlock (
  IN   EFI_ACPI_6_4_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE *GhesV2,
...
/**
  ...
  @retval     EFI_SUCCESS            Success.
  @retval     EFI_INVALID_PARAMETER  GHES it NULL or NumofGhesV2 is not equal to MAX_GHES.
  ...
  )
{
  ...
  UINT32         ErrorSeverityArray[MAX_GHES] = {
                   EFI_ACPI_6_4_ERROR_SEVERITY_CORRECTABLE,
                   EFI_ACPI_6_4_ERROR_SEVERITY_FATAL,
                   EFI_ACPI_6_4_ERROR_SEVERITY_CORRECTED,
                   EFI_ACPI_6_3_ERROR_SEVERITY_NONE};
  VOID           *ErrorBlockHead;
  VOID           *ErrorBlock;
  VOID           *BlockMemory;
  ...
  BlockMemory = (VOID*) ((UINT64) (PcdGet64 (PcdRasMemoryBase)   \
                   + PcdGet64 (PcdHestRegionOffset)));
  ...
  //
  //SDEI according severity level
  //
  for (Iter = 0; Iter < MAX_GHES - 2; Iter++) {
  ...
  GhesV2AddNotification (
    &GhesV2[Iter],
    EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_ARMV8_SEA,
    Iter
    );
  ErrorBlockInitial (ErrorBlock, ErrorSeverityArray[Iter]);
  GhesV2LinkErrorBlock (&GhesV2[Iter], &GhesRegisters[Iter], ErrorBlock);
  ...
  GhesV2AddNotification (
    &GhesV2[Iter],
    EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_ARMV8_SEI,
    Iter
    );
  ErrorBlockInitial (ErrorBlock, ErrorSeverityArray[Iter]);
  GhesV2LinkErrorBlock (&GhesV2[Iter], &GhesRegisters[Iter], ErrorBlock);
