...
EINJ_TABLE mEinj = {
  ...
  {
    {
      // 0 EFI_ACPI_6_4_EINJ_BEGIN_INJECTION_OPERATION
      EFI_ACPI_6_4_EINJ_BEGIN_INJECTION_OPERATION,
      EFI_ACPI_6_4_EINJ_WRITE_REGISTER_VALUE,
      EFI_ACPI_6_4_EINJ_PRESERVE_REGISTER,
      0,
      {
    ...
    {
      // 1 EFI_ACPI_6_4_EINJ_GET_TRIGGER_ERROR_ACTION_TABLE
    ...
    {
      // 2 EFI_ACPI_6_4_EINJ_SET_ERROR_TYPE
      EFI_ACPI_6_4_EINJ_SET_ERROR_TYPE,
      EFI_ACPI_6_4_EINJ_WRITE_REGISTER,
      EFI_ACPI_6_4_EINJ_PRESERVE_REGISTER,
      0,
      {
        EFI_ACPI_6_4_SYSTEM_MEMORY,
    ...
    {
      // 3 EFI_ACPI_6_4_EINJ_GET_ERROR_TYPE
      EFI_ACPI_6_4_EINJ_GET_ERROR_TYPE,
      EFI_ACPI_6_4_EINJ_READ_REGISTER,
      0,
      0,
      {
    ...
    {
      // 4 EFI_ACPI_6_4_EINJ_END_OPERATION
      EFI_ACPI_6_4_EINJ_END_OPERATION,
      EFI_ACPI_6_4_EINJ_WRITE_REGISTER_VALUE,
      EFI_ACPI_6_4_EINJ_PRESERVE_REGISTER,
      0,
      {
    ...
    {
      // 5 EFI_ACPI_6_4_EINJ_EXECUTE_OPERATION
      ...
      0,
      {
        ...
        EFI_ACPI_6_4_DWORD,
        //0x1B00002C            //todo
        FixedPcdGet64 (PcdRasEinjExexuteOperationAddress)
      },
      1,
      0xFFFFFFFF //BIT0
    },
    {
      // 6 EFI_ACPI_6_4_EINJ_CHECK_BUSY_STATUS
      EFI_ACPI_6_4_EINJ_CHECK_BUSY_STATUS,
      EFI_ACPI_6_4_EINJ_READ_REGISTER_VALUE,
      0,
      0,
      {
        EFI_ACPI_6_4_SYSTEM_MEMORY,
    ...
    {
      // 7 EFI_ACPI_6_4_EINJ_GET_COMMAND_STATUS
...
EINJ_TRIGGER_ERROR_ACTION mEinjTriggerErrorAction = {
  {
    sizeof (EFI_ACPI_6_4_EINJ_TRIGGER_ACTION_TABLE),
    0,
...
{
  EFI_ACPI_6_4_EINJ_INJECTION_INSTRUCTION_ENTRY  *KeyEntry;
