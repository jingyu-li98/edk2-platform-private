  ...
  )
{
  ...
  CHAR16         *ConfigChangeResetToApplyString;
  CHAR16         *PressEntertoResetString;
  ...
  if (IsResetRequired ()) {
    ...
    ConfigChangeResetToApplyString = HiiGetString (gStringPackHandle, STRING_TOKEN (STR_CONFIG_CHANGE_APPLY), NULL);
    PressEntertoResetString = HiiGetString (gStringPackHandle, STRING_TOKEN (STR_PRESS_ENTER_RESET), NULL);
    StrCpyS (StringBuffer1, MAX_STRING_LEN, ConfigChangeResetToApplyString);
    StrCpyS (StringBuffer2, MAX_STRING_LEN, PressEntertoResetString);
