  ...
  )
{
  ...
  /*sunrui - Boot Next Value HiiCreateOneOfOpCode (
    StartOpCodeHandle,
...
BmmCreateTimeOutMenu (
  IN EFI_HII_HANDLE              HiiHandle,
  IN VOID                        *StartOpCodeHandle
  //IN BMM_CALLBACK_DATA                *CallbackData//sunruitest +
  )
{
  //sunrui +
  ...
  BootTimeOut = PcdGet16 (PcdPlatformBootTimeOutDefault);
  ...
  HiiCreateNumericOpCode (
    ...
    65535,
    0,
    DefaultOpCodeHandle//sunrui change NULL ->DefaultOpCodeHandle
    );
     //sunrui +
...
{
  /*sunrui - Boot from File HiiCreateGotoOpCode (
    StartOpCodeHandle,
    FORM_MAIN_ID,
