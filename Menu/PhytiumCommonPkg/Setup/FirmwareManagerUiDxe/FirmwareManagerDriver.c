/** @file
The module entry point for Firmware Manager configuration module.
...
/**
  The entry point for Phytium Firmware Manager configuration driver.
...
/**
  Unload the Phytium Firmware Manager configuration form.
